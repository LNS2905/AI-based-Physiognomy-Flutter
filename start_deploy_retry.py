...
try:
    ...
    print("\n--- CHECKING IMAGES ---")
    execute_command(client, "docker images")
    
    print("\n--- RETRYING DEPLOY ---")
    # Try to build explicitly first
    cmd_build = "cd /root/AIPhysiognomy && /usr/local/bin/docker-compose build"
    execute_command(client, cmd_build)
